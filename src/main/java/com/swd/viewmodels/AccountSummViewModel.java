...
public class AccountSummViewModel {
    public String _id;
    public String name;
    public String email;
    public Date dob;
    ...
    public AccountSummViewModel(ObjectId _id) throws NullPointerException {
        MongoDaoBaseClass<Account> accdao = new MongoDaoBaseClass<>("account");
